...
import { AppConstants } from '../modules/common/types/app-constants';
import { DocAuthService } from '../services/doc-auth.service';
...
export class DocGuard implements CanActivate {
  ...
  constructor(private authService:DocAuthService,private router:Router){}
